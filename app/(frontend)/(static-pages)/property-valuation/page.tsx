          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="breadcumb-style1">
                <h2 className="title text-white">Property Valuation</h2>
          ...
          <div className="row" data-aos="fade-up" data-aos-delay="300">
            <div className="col-lg-6">
              ...
              <p className="text mb25">
                We have a dedicated team to evaluate each property in detail and
                get the most accurate value of any property. We believe that all
                properties are very much different and therefore we serve every
                client on one to one basis. We help our clients get their
                property's Market Value, Value-in-Use, Insurable Value and
                Liquidation Value. We determine these values through a process
                we have built over a period of years. Our property valuation
                services are in huge demand in Mumbai, Navi Mumbai and Thane.
              </p>
              <p className="text mb55">
                You can feel free to talk to our property valuation consultant
                anytime and get property valuation advice on property matters of
                purchase/lease, taxation, legal disputes etc.
              </p>
            </div>
            <div className="col-lg-6">
